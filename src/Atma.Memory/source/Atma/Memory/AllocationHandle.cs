namespace Atma.Memory
{
    ...
    public unsafe struct AllocationHandle
    {
        public void* Address;
        ...
        internal AllocationHandle(void* address, Allocator allocator, uint heapIndex, uint checksum)
        {
            Address = address;
        ...
        internal AllocationHandle Clone()
        {
