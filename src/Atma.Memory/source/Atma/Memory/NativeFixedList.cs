namespace Atma.Memory
{
    ...
    [System.Diagnostics.DebuggerStepThrough]
    public unsafe ref struct NativeFixedList2<T>
     where T : unmanaged
    {
        ...
        public NativeFixedList2(Span<T> data, int length = 0)
        {
            _span = data;
            _length = length;
        }
        ...
        public static implicit operator Span<T>(NativeFixedList2<T> it) => it._span;

        public static implicit operator NativeFixedList2<T>(Span<T> it) => new NativeFixedList2<T>(it);
